            ...
            if (!response.equals("")) {
                try {
                    ...
                    if (ErrorCode == 0) {
                        ...
                        revisionHistory.edit().putString("name",mNameAssortment).putString("count",String.format("%.2f", total_count)).apply();
                        ...
                        AlertDialog.Builder dialog = new AlertDialog.Builder(CountListOfAssortmentInventory.this);

...
public class Inventory extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleAdapterASL = new SimpleAdapter(this, asl_list_added,R.layout.show_asl_inventory, new String[]{"Name","Cant"},
                new int[]{R.id.textName,R.id.textCantitate});
            ...
            if (!response.equals("")) {
                try {
                    ...
                    if (ErrorCode == 0) {
                        ...
                        Count_init= Double.valueOf(ExistingCount);
            ...
            if (!response.equals("")) {
                try {
                    ...
                    if (ErrorCode == 0) {
                        ...
                        String count_total= String.format("%.2f",total_count);
                        count_total = count_total.replace(",",".");

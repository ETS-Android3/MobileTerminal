...
public class Variables extends Application {
    ...
    private HashMap<String,Assortment> AssortimentParentID =new HashMap<>();
    private HashMap<String, Assortment> Barcode  = new HashMap<>();
    private HashMap<String, Assortment> Code = new HashMap<>();
    List<Assortment> assortmentListData;
...
//    public HashMap<String,Assortment> get_Assortiment() {
//        return AssortimentID;
//    }
//    public ArrayList<HashMap<String, Object>> get_ParentAssortiment() {
//        ArrayList<HashMap<String, Object>> asl_list = new ArrayList<>();
//        if(AssortimentID!=null)
//            for (String key: AssortimentID.keySet()) {
//                Assortment sal = AssortimentID.get(key);
...
//                String parent =  sal.getAssortimentParentID();
//                boolean is_folder= sal.getIsFolder();
//                if(parent.equals("00000000-0000-0000-0000-000000000000")) {
//                    HashMap<String, Object> asl_ = new HashMap<>();
//                    String asl_name= sal.getName();
//                    String uid_asl = sal.getAssortimentID();
//                    if (!is_folder) {
